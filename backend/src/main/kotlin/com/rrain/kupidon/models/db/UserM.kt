...
import com.rrain.utils.base.`date-time`.getAge
...
data class UserM(
  ...
  var privacySettings: UserPrivacySettingsM = UserPrivacySettingsM(),
  
  // Настройки уведомлений
  var notificationSettings: UserNotificationSettingsM = UserNotificationSettingsM(),
) {
  ...
  fun toApi(
    ...
    return when (userType) {
      ...
      UserDataType.Current -> mutableMapOf(
        ...
        //"onlineAt" to
        "online" to UserLiveStatusService.isUserOnline(id),
        "privacySettings" to privacySettings,
